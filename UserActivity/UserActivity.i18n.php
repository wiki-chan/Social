...
/** Korean
 * Wikichan 사용을 위한 특수 번역입니다.
 */
$messages['ko'] = array(
	'useractivity' => "친구들의 위키 활동",
	'useractivity-award' => '$1 님이 업적 보상을 획득했습니다.',
	'useractivity-all' => '모두 보이기',
	'useractivity-edit' => '$1 님이 다음 {{PLURAL:$4|문서를|문서들을}} 편집했습니다. $3',
	// 'useractivity-foe' => '$1 {{PLURAL:$2|is now foes with|are now foes with}} $3',
	'useractivity-friend' => '$1 님이 $3 님과 친구가 되었습니다.',
	// 'useractivity-gift' => '$1 님이 $2 님으로부터 선물을 받았습니다.',
	'useractivity-group-edit' => '$1회 편집',
	'useractivity-group-comment' => '$1회 댓글',
	'useractivity-group-user_message' => '$1회 메시지',
	'useractivity-group-friend' => '$1회 친구 추가',
	'useractivity-siteactivity' => '사이트 활동',
	'useractivity-title' => "친구들의 위키 활동",
	'useractivity-user_message' => '$1 님이 $3 님에게 {{PLURAL:$4|메시지를|메시지들을}} 보냈습니다.',
	'useractivity-comment' => '$1 님이 다음 {{PLURAL:$4|문서에|문서들에}} 댓글을 남겼습니다. $3',
);
