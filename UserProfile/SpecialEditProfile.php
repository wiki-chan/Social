...
*/
		...
		<div class="profile-update" id="profile-update-personal-work">
			...
			<p class="profile-update-unit">
				<textarea name="occupation" id="occupation" rows="1" cols="75">' . ( isset( $occupation ) ? $occupation : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
		</div>
		<div class="cleared"></div>
		...
		<div class="profile-update" id="profile-update-personal-education">
			...
			<p class="profile-update-unit">
				<textarea name="schools" id="schools" rows="1" cols="75">' . ( isset( $schools ) ? $schools : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
		</div>
		<div class="cleared"></div>
		...
		<div class="profile-update" id="profile-update-personal-places">
			...
			<p class="profile-update-unit">
				<textarea name="places" id="places" rows="1" cols="75">' . ( isset( $places ) ? $places : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
		</div>
		<div class="cleared"></div>
		...
		<div class="profile-update" id="profile-update-personal-web">
			...
			<p class="profile-update-unit">
				<textarea name="websites" id="websites" rows="1" cols="75">' . ( isset( $websites ) ? $websites : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
		</div>
		<div class="cleared"></div>';
	...
	function displayPersonalForm( $tar ) {
		...
		$s = $dbr->selectRow( 'user_profile',
			array(
				...
				'up_occupation', 'up_companies', 'up_schools', 'up_movies', 'up_character_1',
		...
		$form = '<div class="profile-info clearfix">
			...
			<p class="profile-update-unit">
				<textarea name="movies" id="movies" rows="1" cols="75">' . ( isset( $character_1 ) ? $character_1 : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			<p class="profile-update-unit-left">' . wfMsg( 'user-profile-interests-tv' ) . '</p>
			<p class="profile-update-unit">
				<textarea name="tv" id="tv" rows="1" cols="75">' . ( isset( $tv ) ? $tv : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			<p class="profile-update-unit-left">' . wfMsg( 'user-profile-interests-music' ) . '</p>
			<p class="profile-update-unit">
				<textarea name="music" id="music" rows="1" cols="75">' . ( isset( $music ) ? $music : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			<p class="profile-update-unit-left">' . wfMsg( 'user-profile-interests-books' ) . '</p>
			<p class="profile-update-unit">
				<textarea name="books" id="books" rows="1" cols="75">' . ( isset( $books ) ? $books : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			</div>
			...
			<p class="profile-update-unit">
				<textarea name="magazines" id="magazines" rows="1" cols="75">' . ( isset( $magazines ) ? $magazines : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			<p class="profile-update-unit-left">' . wfMsg( 'user-profile-interests-videogames' ) . '</p>
			<p class="profile-update-unit">
				<textarea name="videogames" id="videogames" rows="1" cols="75">' . ( isset( $videogames ) ? $videogames : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			<p class="profile-update-unit-left">' . wfMsg( 'user-profile-interests-foodsnacks' ) . '</p>
			<p class="profile-update-unit">
				<textarea name="snacks" id="snacks" rows="1" cols="75">' . ( isset( $snacks ) ? $snacks : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			<p class="profile-update-unit-left">' . wfMsg( 'user-profile-interests-drinks' ) . '</p>
			<p class="profile-update-unit">
				<textarea name="drinks" id="drinks" rows="1" cols="75">' . ( isset( $drinks ) ? $drinks : '' ) . '</textarea>
			</p>
			<div class="cleared"></div>
			</div>
			</div>';
	...
	function displayCustomForm( $tar ) {
		...
		$form = '<div class="profile-info clearfix">
				<div class="profile-update">
					...
					<p class="profile-update-unit">
						<textarea name="custom1" id="fav_moment" rows="1" cols="75">' . ( isset( $custom1 ) ? $custom1 : '' ) . '</textarea>
					</p>
					</div>
					<div class="cleared"></div>
					...
					<p class="profile-update-unit">
						<textarea name="custom2" id="least_moment" rows="1" cols="75">' . ( isset( $custom2 ) ? $custom2 : '' ) . '</textarea>
					</p>
					</div>
					<div class="cleared"></div>
					...
					<p class="profile-update-unit">
						<textarea name="custom3" id="fav_athlete" rows="1" cols="75">' . ( isset( $custom3 ) ? $custom3 : '' ) . '</textarea>
					</p>
					</div>
					<div class="cleared"></div>
					...
					<p class="profile-update-unit">
						<textarea name="custom4" id="least_fav_athlete" rows="1" cols="75">' . ( isset( $custom4 ) ? $custom4 : '' ) . '</textarea>
					</p>
					</div>
					<div class="cleared"></div>
				</div>
